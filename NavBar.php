  <nav class="site-navigation text-right text-md-center" role="navigation">
      <ul class="site-menu js-clone-nav d-none d-lg-block">
          ...
          <li><a href="#" onclick="window.location.href='bookings.php'"><i class="fa fa-calendar-alt"></i>&nbsp;Bookings</a></li>
          <li><a href="#" onclick="window.location.href='contact.php'"><i class="icon-phone"></i>&nbsp;Contact</a></li>
          <li><a href="#" onclick="window.location.href='login.php'"><i class="icon-lock"></i>&nbsp;Login</a></li>
      </ul>
  </nav>