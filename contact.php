              ...
              <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="c_fname" name="c_fname" placeholder="Enter firstname" required>
                  </div>
                  <div class="col-md-6">
                    <label for="c_lname" class="text-black">Last Name <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="c_lname" name="c_lname" placeholder="Enter lastname" required>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-12">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <button type="submit" class="btn btn-primary">Send Message&nbsp;<i class="icon-send"></i></button>
                  </div>
                  <div class="col-md-5"></div>
                </div>
              </div>
