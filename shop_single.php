      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.php">Store</a> <span class="mx-2 mb-0">/</span><strong class="text-black"><?php echo $product_name.' , '.$product_mg_bottle.'mg'.' , <b>'.$product_price;?> Frw</b></strong></div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row"> 
          ...
          <div class="col-md-6">
            ...
            <p><strong class="text-primary h4"><span id="output" style="font-weight: bold;"><?php echo $product_price;?></span> <span style="font-weight: bold;">Frw</span></strong></p>
